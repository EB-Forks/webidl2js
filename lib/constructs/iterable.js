    ...
    if (this.isPair) {
      ...
      this.interface.addMethod(whence, "forEach", ["callback"], `
        ...
        if (arguments.length < 1) {
          throw new globalObject.TypeError("Failed to execute 'forEach' on '${this.name}': 1 argument required, " +
                              "but only 0 present.");
        }
      ...
      this.interface.addProperty(whence, "values", "globalObject.Array.prototype[Symbol.iterator]");
